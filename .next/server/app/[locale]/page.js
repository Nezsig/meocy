(()=>{var a={};a.id=465,a.ids=[465],a.modules={146:(a,b,c)=>{"use strict";c.d(b,{default:()=>h});var d=c(21124),e=c(38301),f=c(3991),g=c.n(f);function h(){let[a,b]=(0,e.useState)("product"),[c,f]=(0,e.useState)(20),[h,i]=(0,e.useState)("studio"),[j,k]=(0,e.useState)([]),l={product:200,fashion:210,restaurant:220,model:230},m={modelCasting:100,styling:75,videoClips:200,expressDelivery:150},{breakdown:n,minPrice:o}=(0,e.useMemo)(()=>{let b=l[a],d=20*Math.ceil(c/5);"onLocation"===h&&(b+=150);let e=0;j.forEach(a=>{e+=m[a]||0});let f=b+d+e,g=Math.round(.9*f);return{breakdown:{service:b,images:d,location:150*("onLocation"===h),addOns:e},total:f,minPrice:g}},[a,c,h,j]);return(0,d.jsxs)("section",{className:"calculator-section",children:[(0,d.jsx)("style",{children:`
        .calculator-section {
          background: var(--bg);
          padding: 100px 0;
        }
